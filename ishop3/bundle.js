...
var _iShop = __webpack_require__(29);
...
function initiate() {
    var product = __webpack_require__(37);
...
var _GoodsEdit = __webpack_require__(33);

var _GoodsEdit2 = _interopRequireDefault(_GoodsEdit);

var _GoodsItem = __webpack_require__(35);
    ...
    _createClass(iShop3, [{
        ...
        value: function render() {
            ...
            if (this.state.intGoodsArr.length > 0) {
                ...
                var tableBlock = _reactDomFactories2.default.table(null, _reactDomFactories2.default.caption(null, "Товары на складе"), _reactDomFactories2.default.tbody(null, _reactDomFactories2.default.tr(null, _reactDomFactories2.default.th(null, "Товар"), _reactDomFactories2.default.th(null, "Описание"), _reactDomFactories2.default.th(null, "Цена"), _reactDomFactories2.default.th(null, "Количество"), _reactDomFactories2.default.td(null)), outTableCode));
                if (!this.state.keyEdit) {
                    //окна редактирования нет
                    return _reactDomFactories2.default.div(null, tableBlock, _reactDomFactories2.default.div(null, _reactDomFactories2.default.button({ className: 'newButton', onClick: this.getNewGoods }, 'New position')));
                } else //окно редактирования есть
                    if (this.statusButtonOk == "Add") //режим нового товара
                        return _reactDomFactories2.default.div(null, tableBlock, _react2.default.createElement(_GoodsEdit2.default, { statusButtonOk: this.statusButtonOk,
                            code: this.newCode,
                            cbSaveEdit: this.saveNewGoods,
                            cbExitEdit: this.exitEditGoods
                        }));else return _reactDomFactories2.default.div(null, tableBlock, _react2.default.createElement(_GoodsEdit2.default, //режим вызова существующего товара
            ...
            } else return _reactDomFactories2.default.div(null, _reactDomFactories2.default.span(null, 'Нет товаров')); //нет товаров в списке вообще
        }
    }]);
...
iShop3.propTypes = {
    goods: _propTypes2.default.arrayOf(_propTypes2.default.shape({
        ...
        qnt: _propTypes2.default.number.isRequired
    }))
};
;
...
var GoodsEdit = function (_React$Component) {
    ...
    function GoodsEdit() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = GoodsEdit.__proto__ || Object.getPrototypeOf(GoodsEdit)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
    ...
    _createClass(GoodsEdit, [{
        ...
        value: function render() {
            ...
            return _reactDomFactories2.default.div({ className: 'hideBlock' }, _reactDomFactories2.default.div({ className: 'goodsEdit' }, _reactDomFactories2.default.div({ className: 'goodsInput' }, _reactDomFactories2.default.label({ htmlFor: 'name' }, 'Название товара:'), _reactDomFactories2.default.input({ type: 'text', id: 'name', defaultValue: this.state.name, onChange: this.nameHandler.bind(this) })), _reactDomFactories2.default.div({ className: 'goodsInput' }, _reactDomFactories2.default.label({ htmlFor: 'price' }, 'Цена:'), _reactDomFactories2.default.input({ type: 'text', id: 'price', defaultValue: this.state.price, onChange: this.priceHandler.bind(this) })), _reactDomFactories2.default.div({ className: 'goodsInput' }, _reactDomFactories2.default.label({ htmlFor: 'qnt' }, 'Количество:'), _reactDomFactories2.default.input({ type: 'text', id: 'qnt', defaultValue: this.state.qnt, onChange: this.qntHandler.bind(this) })), _reactDomFactories2.default.div({ className: 'goodsInput' }, _reactDomFactories2.default.label({ htmlFor: 'desc' }, 'Описание:'), _reactDomFactories2.default.textarea({ id: 'desc', defaultValue: this.state.desc, onChange: this.descHandler.bind(this) })), _reactDomFactories2.default.div(null, _reactDomFactories2.default.button({ onClick: this.checkValidDate.bind(this) }, this.props.statusButtonOk), _reactDomFactories2.default.button({ onClick: (_context = this.props).cbExitEdit.bind(_context) }, 'Exit'))));
        }
    }]);
...
GoodsEdit.propTypes = {
    ...
    qnt: _propTypes2.default.number,
    statusButtonOk: _propTypes2.default.string.isRequired,
    cbExitEdit: _propTypes2.default.func.isRequired,
    cbSaveEdit: _propTypes2.default.func.isRequired
};
GoodsEdit.defaultProps = {
    name: '',
    desc: '',
    price: 0,
    qnt: 0
...
var GoodsItem = function (_React$Component) {
    ...
    _createClass(GoodsItem, [{
        ...
        key: 'render',
        value: function render() {
            return _reactDomFactories2.default.tr({ className: 'goodsItem' }, _reactDomFactories2.default.td(null, this.props.name), _reactDomFactories2.default.td(null, this.props.desc), _reactDomFactories2.default.td(null, this.props.price.toFixed(2)), _reactDomFactories2.default.td(null, this.props.qnt), _reactDomFactories2.default.td(null, _reactDomFactories2.default.button({ onClick: this.handlerButtonEdit }, 'Edit'), _reactDomFactories2.default.button({ onClick: this.handlerButtonDel }, 'Delete')));
        }
    }]);
...
GoodsItem.propTypes = {
    ...
    qnt: _propTypes2.default.number.isRequired,
    price: _propTypes2.default.number.isRequired,
    keyEdit: _propTypes2.default.bool.isRequired,
    cbEditClick: _propTypes2.default.func.isRequired,
    cbDelClick: _propTypes2.default.func.isRequired
};
;
